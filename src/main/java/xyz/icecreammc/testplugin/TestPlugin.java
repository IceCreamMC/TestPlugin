...
import xyz.icecreammc.testplugin.listener.*;
import xyz.icecreammc.testplugin.service.TestService;
import xyz.icecreammc.testplugin.service.TestServiceImpl;
...
public class TestPlugin extends Plugin {
    ...
    public void bootstrap(@NotNull BootstrapContext ctx) {
        getLogger().info("Welcome to the ICMC Test Plugin {}!", ctx.getServerVersion().getName());
